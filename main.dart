...
int value = 0;
String ageStatus = 'A single cell';
String message = "Not Yet Born";
...
class Counter with ChangeNotifier {
  ...
  if ( value > 51){
    ...
    ageStatus = "Adult";
    message = "Youre an adult now";
    color = Colors.orange;
  }
  else if (value > 20 && value < 30){
    ageStatus = "Young adult";
    message = "Youre a young adult";
    color = Colors.yellow;
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Consumer<Counter>(
              builder: (context, counter, child) => Text( "$ageStatus\n" "$message\n" 'I Am '
                '$value' ' Years Old',
